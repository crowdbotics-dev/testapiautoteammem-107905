...
## Project Structure
    ...
    ├── testapiautoteammem_107905  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_107905`
...
2. Clone this repo and `cd testapiautoteammem_107905`
